...
- [ ] 2026.1.4-2026.1.6 收尾latency统计脚本，准备好OPs理论能耗脚本 @余帝
- [ ] 2026.1.4-2026.2.1 收尾附录详情 @余帝
- [ ] 2026.1.4-2026.1.7 定稿Fig 2 (SNN-bench)正文展示 @余帝
- [ ] 2026.1.4-2026.1.10 补全Table 1 @余帝 @郑赫霖
- [ ] 2026.1.6-2026.1.9 熟悉使用NeuSim做推理，并成功运行结果 @张炜松 @郑赫霖 @陈卓
- [ ] 2026.1.6-2026.1.9 熟悉使用Darwin片上推理操作，并成功运行结果 @张炜松 @郑赫霖 @童文韬
- [ ] 2026.1.9-2026.1.20 完成三种延迟结果统计（真实+理论），理论推理能耗统计
- [ ] 2026.1.10-2026.1.12 定稿Fig 5 (Soul-NeuSim推广展望)正文展示 @余帝
