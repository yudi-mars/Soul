...
class NeuSimEnergyModel:
    ...
    def estimate_energy(self, sim_res):
        sop_energy = self._sop_energy * sim_res.total_recv_spikes
        neuron_energy = self._neuron_energy * (
            sim_res.total_update_cnt - sim_res.total_firing_cnt
        )
        spike_energy = self._spike_energy * sim_res.total_firing_cnt
        hop_energy = self._hop_energy * sim_res.total_hops
