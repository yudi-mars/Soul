...
Description:
    Implementation of Spikingformer (spike-driven Transformer SNN) for wireless domain.

    Wireless input: (T, B, C, H, W) -- same 5D format as vision.
    No reshaping needed; uses input_channels, input_height, input_width directly.
...
class Spikingformer(nn.Module):
    """
    Spikingformer for wireless domain.
    ...
    def forward(self, x):
        # Wireless input: (T, B, C, H, W) -- already has T dimension
