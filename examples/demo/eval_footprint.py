'''
Memory footprint monitor for SNN model inference towards samples one-by-one
'''
...
print('Monitoring maximum memory usage for inference')
...
print(f"Actual GPU memory usage for inference one sample with {config['model']}: {final_max_mem / (1024 ** 2):.2f} MB")
