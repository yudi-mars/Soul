...
介绍：
    适用于边缘场景的脉冲多层感知机网络结构，针对视觉图像处理任务进行了定制优化。
特殊配置：
...
介绍：
    适用于边缘场景的脉冲LeNet网络结构，针对视觉图像处理任务进行了定制优化。
特殊配置：
...
介绍：
    适用于边缘场景的脉冲循环神经网络结构，针对视觉图像处理任务进行了定制优化。
特殊配置：
...
介绍：
    适用于边缘场景的脉冲卷积循环神经网络结构，针对视觉图像处理任务进行了定制优化。
特殊配置：
    * hidden_dim:128 （int）内部循环层的隐藏维度
    * num_layers:1 （int）循环层数量
...
使用方法：
    设置--model或-m：spikingvgg5、spikingvgg9、spikingvgg11、spikingvgg13、spikingvgg16、spikingvgg19
参数量：
...
使用方法：
    设置--model或-m：sewresnet18、sewresnet34、sewresnet50
参数量：
...
使用方法：
    设置--model或-m：msresnet18、msresnet34、msresnet50
参数量：
...
介绍：
    适用于图像数据分类任务的 Transformer 架构脉冲神经网络模型实现。
